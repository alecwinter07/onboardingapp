...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'nmls_company_id', label: 'NMLS Company ID (if mortgage-related)', type: 'text', required: true },
      { key: 'nmls_originator_id', label: 'NMLS Originator ID (personal, if applicable)', type: 'text', required: true },
